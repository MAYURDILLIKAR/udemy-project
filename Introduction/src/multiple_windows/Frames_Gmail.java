...
public class Frames_Gmail {
	...
	public static void main(String[] args) throws Exception {
		...
		// driver.findElement(By.xpath("//ul[@class='h-c-header__cta-list
		// header__nav--ltr']//a[contains(@class,'h-c-header__nav-li-link')][contains(text(),'Sign
		// in')]"));
		driver.findElement(By.linkText("Help")).click();
		Set<String> se = driver.getWindowHandles(); // this command takes all the window handles and store in se
